...
#[derive(Debug)]
pub struct ioTubeRouterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ioTubeRouterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ioTubeRouter processing");
    
    let mut processor = ioTubeRouterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ioTubeRouterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ioTubeRouterProcessor::new(false);
